  ...
  <div class="wrapper board">
    <div class="section section-pricing-5 mt-10 page-header header-filter" :style="headerStyle">
      <div class="container">
        ...
        <div class="md-layout" style="padding-top:110px;">
          <div class="md-layout-item md-size-60 md-small-size-100" style="text-align: justify">
            <p
              style="font-size:1.1rem;"
            >Le Lobby citoyen MUSES tire sa force de femmes et d’hommes qui refusent de se résigner face aux dérives du système, au moins-disant social et au dépôt de bilan planétaire qui nous guette, convaincus de la nécessité d’agir au profit d'un idéal de société.</p>
            <p
              style="font-size:1.1rem;"
            >Vous engager à nos côtés, c’est choisir une démarche collective et tournée vers l’avenir pour l’élaboration d’un modèle alternatif prenant en compte les réalités et besoins du quotidien.</p>
          </div>

          <div class="md-layout-item md-size-40 md-small-hide" style="text-align: center;">
        ...
        <div class="md-layout">
          ...
          <div class="md-layout-item md-size-40 md-small-size-100">
            <div class="md-layout-item md-size-100">
              <div class="md-card md-card-pricing md-theme-default" style="margin: 0">
                <div class="md-card-content" style="text-align: center;">
                  <h3 class="card-title">7,90 € / mois</h3>
                  <h4 class="card-title">
                    2,68 € / mois
                    <br />après déduction fiscale
                  </h4>
                  <p
                    class="card-description"
                    style="font-size:.9rem; color:#5C5C5C;"
                  >Une valeur symbolique équivalant à donner une heure de son temps par mois que vous soyez un citoyen ou un travailleur.</p>
                  <a href="javascript:void(0)" class="md-button md-rose md-round md-theme-default">
                    <div class="md-ripple">
                      <div @click="checkout('standard')" class="md-button-content">S'engager</div>
                    </div>
                  </a>
                </div>
              </div>
            ...
            <div class="md-layout-item md-size-100">
              <div class="md-card md-card-pricing md-theme-default">
                <div class="md-card-content" style="text-align: center;">
                  <h3 class="card-title">3,95 € / mois</h3>
                  <h4 class="card-title">
                    1,34 € / mois
                    <br />après déduction fiscale
                  </h4>
                  <p
                    class="card-description"
                    style="font-size:.9rem; color:#5C5C5C;"
                  >Pour tous ceux dont les ressources n’excèdent pas le SMIC. Parce que s’engager ne doit pas signifier être étranglé financièrement.</p>
                  <a href="javascript:void(0)" class="md-button md-rose md-round md-theme-default">
                    <div class="md-ripple">
                      <div @click="checkout('light')" class="md-button-content">S'engager</div>
                    </div>
                  </a>
                </div>
                <!---->
    ...
    return {
      ...
      plans: {
        standard: {
          ...
          successUrl: `${process.env.VUE_APP_BASE_HOST}/adhesion/confirmation`,
          cancelUrl: `${process.env.VUE_APP_BASE_HOST}/adhesion/annulation`
        },
        light: {
          items: [
            {
              plan: "monthly-membership-discounted",
              quantity: 1
            }
          ],
          clientReferenceId: new Buffer(
  ...
  methods: {
    checkout(plan) {
      try {
        ...
        Stripe(process.env.VUE_APP_STRIPE_PUBLIC_KEY).redirectToCheckout(
          this.plans[plan]
        );
      } catch (e) {
      } finally {
