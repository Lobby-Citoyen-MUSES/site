      ...
      <div class="container">
        <div class="md-layout">
          ...
          >
            ...
            >{{ headline.summary }}</h3>
            <br />
            <md-button :href="'/publication/' + headline.uid" class="md-success md-lg">
        ...
        <div class="container">
          <div class="md-layout" style="flex-wrap:wrap">
              ...
              >
                <div class="md-card-content">
                  ...
                  <div class="card-stats text-center">
                    ...
                    >
                      <div class="md-ripple">
                        <div class="md-button-content">Lire l'édito de {{ editorial.author.fullname }}</div>
                      </div>
                    </a>
                  </div>
                </div>
            ...
            <div class="md-layout-item md-size-77 md-small-size-100" style="display:flex">
              ...
              >
                <div class="md-card-content">
                  <h6 class="card-category text-info">{{ focus.category }}</h6>
                  <a :href="'/publication/' + focus.uid">
                ...
                <div class="md-card-actions">
                  <a
                    :href="'/publication/' + focus.uid"
                    class="md-button md-white md-simple md-theme-default"
                  >
                    <div class="md-ripple">
                      <div class="md-button-content">
                        <i class="md-icon md-icon-font md-theme-default">subject</i> Lire l'article
                      </div>
                    </div>
                  </a>
            ...
            >
              ...
              >
                <div class="md-card-content">
                  <h6 class="card-category text-info">{{ highlight.category }}</h6>
                  <a :href="'/publication/' + highlight.uid">
                ...
                <div class="md-card-actions">
                  <a
                    :href="'/publication/' + highlight.uid"
                    class="md-button md-white md-simple md-theme-default"
                  >
                    <div class="md-ripple">
                      <div class="md-button-content">
